            ...
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className="st-nav-list st-onepage-nav" style={{ display: `${mobileToggle ? 'block' : 'none'}` }}>
                  ...
                  <li><ScrollLink to="service" spy={true} smooth={true} offset={-80} duration={500} onClick={() => setMobileToggle(false)}>Service</ScrollLink></li>
                ...
                <div className="sp-phone">
                  ...
                  <div className="sp-phone-no"> <a href="tel:+96171328063">+961 71328063</a></div>
                </div>
              </div>
            </div>
          </div>
